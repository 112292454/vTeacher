...
(
    ...
    `SceneName` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
);
DROP TABLE IF EXISTS `dialogues`;
CREATE TABLE dialogues
(
    `SceneID`    bigint(20) NOT NULL AUTO_INCREMENT,
    `DialogueName` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
    `DialogueTeacher`   TEXT,
    `DialogueStudent`  TEXT,
